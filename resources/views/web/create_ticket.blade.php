                ...
                <form method="POST" action="{{ route('web.ticket.store') }}" autocomplete="off"
                    ...
                    @if(!Auth::user())
                        ...
                        <div class="registration-title pt-2 pb-2 mb-3 d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="registration-title-heading mb-0">{{ __('messages.ticket.create_ticket') }}</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group  col-lg-6 col-md-12 col-sm-12 col-12">
                                {{ Form::label('company_id', __('messages.company.company').':') }}<span
                                        class="text-danger">*</span>
                                {{ Form::select('company_id', $company ,null, ['id'=>'companyId','class' => 'form-control','placeholder' => __('messages.admin_dashboard.select_company'),'required','tabindex'=>6]) }}
                            </div>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/tickets/create_edit.js')}}"></script>
@endpush
