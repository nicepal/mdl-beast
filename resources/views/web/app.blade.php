...
<!-- Template CSS -->
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/phone-number-code.css') }}" type="text/css"/>
...
<script src="{{ asset('assets/js/custom/phone-number-code.js') }}"></script>
...
<script src="{{ asset('assets/js/web/chat.js') }}"></script>
<script src="{{ asset('assets/js/web/set-user-on-off.js') }}"></script>
